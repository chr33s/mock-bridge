...
function validateConfig(config: MockShopifyAdminConfig): void {
  ...
  if (errors.length > 0) {
    ...
    console.log(chalk.gray('   npx mock-bridge --config mock.config.mjs'));
    console.log();
    process.exit(1);
  }
}
...
`;
  ...
  // .mjs is an ES module whatever the project's package.json "type" is.
  const configPath = path.join(process.cwd(), 'mock.config.mjs');
  ...
  console.log(chalk.green('✅ Created configuration file:'), chalk.cyan('mock.config.mjs'));
  console.log();
  console.log(chalk.white.bold('🎯 Next Steps:'));
  console.log(chalk.gray('   1. Edit'), chalk.cyan('mock.config.mjs'), chalk.gray('with your app settings'));
  console.log(chalk.gray('   2. Set'), chalk.cyan('SHOPIFY_API_KEY'), chalk.gray('environment variable'));
  console.log(chalk.gray('   3. Run'), chalk.green('npx mock-bridge --config mock.config.mjs'), chalk.gray('to start'));
  console.log();
  console.log(chalk.yellow('💡 Example package.json scripts:'));
  console.log(chalk.gray('   {'));
  console.log(chalk.gray('     "scripts": {'));
  console.log(chalk.gray('       "mock:admin": "mock-bridge --config mock.config.mjs",'));
...
Examples:
  ...
  $ npx mock-bridge --config mock.config.mjs
...
Configuration File:
  Use 'npx mock-bridge init' to create a mock.config.mjs file
